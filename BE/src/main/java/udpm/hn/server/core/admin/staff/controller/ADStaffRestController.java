...
public class ADStaffRestController {
    ...
    public ResponseEntity<?> deleteStaff(@PathVariable String id){
        return Helper.createResponseEntity(adStaffService.deleteStaff(id));
    }

    @DeleteMapping("/staff-facility/{id}")
    public ResponseEntity<?> deleteStaffFacility(@PathVariable String id){
        return Helper.createResponseEntity(adStaffService.deleteStaffByFDM(id));
    }
