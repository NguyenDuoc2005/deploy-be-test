...
public class TodoByPhaseProjectServiceImpl implements TodoByPhaseProjectService {
    ...
    @Override
    public ResponseObject<?> getAllTodoByPhaseProject(String idProject, String idPhase) {
        Pageable pageable = PageRequest.of(0, 10, Sort.by("createdDate").descending());
        Page<TodoByPhaseProjectResponse> results = todoTableByPhaseProjectRepository.getAllTodoByPhaseProject(pageable, idProject, idPhase);
    ...
    @Override
    public ResponseObject<?> getLogsImportTodo(int page, int size) {
        if (page < 1) {
            page = 1;
        }
        ...
        Page<HistoryImportTodo> historyPage = historyImportTodoRepository.findAll(pageable);
