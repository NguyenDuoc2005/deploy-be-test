...
public class MBReportController {
    ...
    public ResponseEntity<?> update(@RequestBody MBReportRequest request, @PathVariable String id){
        return Helper.createResponseEntity(mbReportService.update(id, request));
    }
