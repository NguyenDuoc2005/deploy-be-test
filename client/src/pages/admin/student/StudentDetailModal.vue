<template>
    <a-modal :open="open" :title="props.title" @cancel="closeModal" :maskClosable="true" :centered="true">
        <template #footer>
        ...
        <FormCustom>
            <a-form :model="studentDetail" ref="studentForm" name="studentForm" autocomplete="off"
                class="space-y-4 p-4">
                <div class="flex flex-col">
                    <label class="font-medium mb-1">Chọn cơ sở</label>
                    <a-select v-model:value="idFacilitySelect" placeholder="Chọn cơ sở" name="facility"
                        :rules="rules.facility">
                        <a-select-option v-for="facility in studentDetailFacility" :key="facility.id"
                            :value="facility.id">
                ...
                <div class="flex flex-col">
                    ...
                    <a-select v-model:value="idDepartmentSelect" placeholder="Chọn bộ môn" name="department"
                        :rules="rules.department">
                        <a-select-option v-for="item in studentDetailDepartment" :key="item.idDepartment"
                ...
                <div class="flex flex-col">
                    ...
                    <a-select v-model:value="idMajorSelect" placeholder="Chọn chuyên ngành" name="major"
                        :rules="rules.major">
                        <a-select-option v-for="dataMajor in studentDetailMajor" :key="dataMajor.idMajor"
...
import { createStudentFDM, studentByDepartmentMajor, updateStudentFDm } from '@/services/api/admin/student.api'
