      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center justify-between">
            ...
            <!-- <a-button v-if="item.status != 'DA_DIEN_RA'" @click.stop="handleFinishEarlyProject(item.id)" type="primary" class="flex items-center justify-center px-4 mr-2">Kết thúc dự án</a-button> -->

            <a-button
              type="primary"
              class="flex items-center justify-center px-4 mr-2"
              @click.stop="handleViewClick(item.id, item.idFacility)"
            >
              Cập nhật dự án
            </a-button>
...
import { ClusterOutlined, ProjectOutlined } from '@ant-design/icons-vue'
...
const emit = defineEmits(['view', 'page-change', 'openSumaryModal'])
