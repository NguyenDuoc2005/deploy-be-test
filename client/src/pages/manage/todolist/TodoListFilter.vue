<template>
    <DivCustom label="Bộ lọc">
        ...
        <div class="flex items-center space-x-2">
            <a-input v-model:value="localSearchQuery" placeholder="Nhập tên task ..." class="w-12/12" />

            <a-select placeholder="Độ ưu tiên" ref="select" v-model:value="searchLevelPriority" style="width: 300px"
                :options="optionLevelPriority"></a-select>

            <a-select placeholder="Trạng thái công việc" ref="select" v-model:value="searchStatusPhase"
                style="width: 400px" :options="optionStatusPhase"></a-select>
...
watch([localSearchQuery, searchLevelPriority, searchStatusPhase],
