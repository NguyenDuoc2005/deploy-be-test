<template>
  ...
  import { AlertOutlined, FireOutlined, SafetyCertificateOutlined, ArrowDownOutlined } from '@ant-design/icons-vue';
  ...
  const priorityOptions = [
      ...
      { value: 1, label: 'Cao', icon: FireOutlined },
      { value: 2, label: 'Trung bình', icon: SafetyCertificateOutlined },
      { value: 3, label: 'Thấp', icon: ArrowDownOutlined },
  ];
